!***********************************************************************
      subroutine turbo_dinamico(inmod,inmodrho,ktime,i_print, &
                 i_rest,in_dx1,in_sn1,in_sp1, &
                        in_st1,in_av1,in_in1, &
                 isotropo,kpstamg,kpendmg)
!***********************************************************************
! compute eddy viscosity and diffusivity with dynamic model
!hicco the scale similar part need a check !!!!

! compute component uf, vf and wf (see Jordan)
...
!     variable declaration
      integer i,j,k,i_rest,i_print
      integer ktime,kper,inmod,inmodrho,lll,m
...
!
      ...
      integer medio_in_k
      double precision nummed_z(n1,n2),denmed_z(n1,n2)
      double precision nummed_loc_z(n1,n2),denmed_loc_z(n1,n2)      
      double precision numrhomed_z(n1,n2),denrhomed_z(n1,n2)
      double precision numrhomed_loc_z(n1,n2),denrhomed_loc_z(n1,n2)      
      real linea_z      
...
! Lik = (ui * Uk)f - uif * Ukf
!
! same computation are done for density
!
