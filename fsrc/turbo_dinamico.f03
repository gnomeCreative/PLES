...
subroutine turbo_dinamico(inmod,inmodrho,ktime,i_print, &
    ...
    integer medio_in_k
    real nummed_z(n1,n2),denmed_z(n1,n2)
    real nummed_loc_z(n1,n2),denmed_loc_z(n1,n2)
    real numrhomed_z(n1,n2),denrhomed_z(n1,n2)
    real numrhomed_loc_z(n1,n2),denrhomed_loc_z(n1,n2)
    real linea_z
