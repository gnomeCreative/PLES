...
contains
    ...
    subroutine jord1(in_dx1,in_sn1,in_sp1,in_st1,in_av1,in_in1)
        ...
        call border_exchange_nodes(gra1)
        call border_exchange_nodes(gra2)
        call border_exchange_nodes(gra3)
...
!        end if
        ...
        if (myid==nproc-1) then
            ...
            call MPI_SENDRECV(gra1(1,1,n3),n1*n2,MPI_REAL_SD,0,101,gra1_appoggio(1,1,1),n1*n2, &
                MPI_REAL_SD,0,201,MPI_COMM_WORLD,status,ierr)

            call MPI_SENDRECV(gra2(1,1,n3),n1*n2,MPI_REAL_SD,0,102,gra2_appoggio(1,1,1),n1*n2, &
                MPI_REAL_SD,0,202,MPI_COMM_WORLD,status,ierr)

            call MPI_SENDRECV(gra3(1,1,n3),n1*n2,MPI_REAL_SD,0,103,gra3_appoggio(1,1,1),n1*n2, &
        ...
        if (myid==0) then
            ...
            call MPI_SENDRECV(gra1(1,1,1),n1*n2,MPI_REAL_SD,nproc-1,201,gra1_appoggio(1,1,n3),n1*n2, &
                MPI_REAL_SD,nproc-1,101,MPI_COMM_WORLD,status,ierr)

            call MPI_SENDRECV(gra2(1,1,1),n1*n2,MPI_REAL_SD,nproc-1,202,gra2_appoggio(1,1,n3),n1*n2, &
                MPI_REAL_SD,nproc-1,102,MPI_COMM_WORLD,status,ierr)

            call MPI_SENDRECV(gra3(1,1,1),n1*n2,MPI_REAL_SD,nproc-1,203,gra3_appoggio(1,1,n3),n1*n2, &
                MPI_REAL_SD,nproc-1,103,MPI_COMM_WORLD,status,ierr)

        end if

        return
    end subroutine jord1
