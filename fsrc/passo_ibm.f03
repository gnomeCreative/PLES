!***********************************************************************
      subroutine passo_ibm(correggo_delu)  
!***********************************************************************
...
!-----------------------------------------------------------------------
      if(icheck)then
      write(900+myid,*)myid,num_left_snd,num_right_snd, &
                            num_left_rcv,num_right_rcv
      end if
...
!hicco AAA nno può andare bene qui con la modifica applicata!
